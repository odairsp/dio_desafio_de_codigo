...
com base em seu consumo mensal de dados. Para a resolução, você pode solicitar ao usuário que insira o seu consumo, sendo este um valor 'float'. 
Crie uma função chamada recomendar_plano para receber o consumo médio mensal de dados informado pelo cliente, além de utilizar estruturas 
...
def recomendar_plano(consumo):
    ...
    planos = {"essencial" : "Plano Essencial Fibra - 50Mbps",
              "prata" : "Plano Prata Fibra - 100Mbps",
              "premium" : "Plano Premium Fibra - 300Mbps"}
    
    # TODO: Crie uma Estrutura Condicional para verifica o consumo médio mensal 
    if consumo > 20:
        recomendado = planos["premium"]
    elif consumo > 10:
        recomendado = planos["prata"]
    else:
        recomendado = planos["essencial"]
